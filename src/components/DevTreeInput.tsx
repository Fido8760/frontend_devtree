...
type DevTreeInputProps = {
    ...
    handleEnableLink: (socialNework: string) => void
}
export default function DevTreeInput({item, handleUrlChange, handleEnableLink} : DevTreeInputProps) {
    ...
    return (
        <div className=" bg-white shadow-sm p-5 flex items-center gap-3">
            ...
            <input type="text" name={item.name} className=" flex-1 border border-gray-100 rounded-lg" value={item.url} onChange={handleUrlChange}/>
